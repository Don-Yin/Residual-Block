...
```
    ...
    Requirement already satisfied: python-dateutil>=2.7 in e:\dropbox\~desktop\coursework-1~7mri0010-advanced-machine-learning\.venv_windows\lib\site-packages (from matplotlib) (2.8.2)
